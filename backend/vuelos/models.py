...
class Vuelo(models.Model):
    ...
    class Meta:
        ...
        managed = False
    def __str__(self):
        return (f"{self.aerolinea} - {self.codigo_vuelo} - {self.origen} - {self.destino} - {self.fecha_salida} - {self.fecha_llegada} - {self.precio_base} - "
                f"{self.asientos_disponibles} - {self.asientos_ocupados} - status: {self.estado_vuelo}")